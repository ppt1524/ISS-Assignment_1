...
Q1---> I have made a single Q1.sh script, with quotes.txt presumed to be the input file and the output is displayed on the terminal.
...
Q5---> Here all the 3 parts are done in a single script Q5.sh. 
